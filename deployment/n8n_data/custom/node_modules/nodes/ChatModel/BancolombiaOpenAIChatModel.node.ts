...
import { openAiFailedAttemptHandler } from '../methods/error-handling';
import { makeN8nLlmFailedAttemptHandler } from '../methods/n8nLlmFailedAttemptHandler';
// Update the import path to the correct relative location, for example:
import { N8nLlmTracing } from '../methods/N8nLlmTracing';

export class BancolombiaOpenAIChatModel implements INodeType {
	methods = {
		listSearch: {
			searchModels,
		},
	...
	description: INodeTypeDescription = {
		displayName: 'Bancolombia Chat Model',

		name: 'BancolombiaOpenAIChatModel',
		icon: { light: 'file:../../icons/bancolombia-ia.svg', dark: 'file:../../icons/bancolombia-ia.dark.svg' },
		group: ['transform'],
		version: [1,2,3],
		description: 'For advanced usage with an AI chain',
		defaults: {
			name: 'Bancolombia Chat Model',
		},
		codex: {
			categories: ['AI'],
			subcategories: {
		...
		properties: [
            ...
            {
                displayName: 'Caso de Uso (Tags)',
                name: 'useCase',
                required: true,
                default: '',
                description:
                    "Name of the use case to help identify the purpose of the model's usage. This is useful for monitoring and managing costs associated with different applications or projects.",
                type: 'string',
            }
		],
	};
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
        ...
        if (useCase) modelKwargs.tags = [useCase];
