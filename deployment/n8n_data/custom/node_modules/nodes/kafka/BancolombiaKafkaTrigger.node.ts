...
export class BancolombiaKafkaTrigger implements INodeType {
  description: INodeTypeDescription = {
    displayName: 'Bancolombia Kafka Trigger',
    name: 'bancolombiaKafkaTrigger',
    icon: {
        ...
        options: [
          {
            ...
            default: false,
            description:
              'Whether to allow sending message to a previously non exisiting topic',
          },
          {
  ...
  async trigger(this: ITriggerFunctions): Promise<ITriggerResponse> {
    ...
    const brokers = ((this.getNodeParameter('brokers') as string) ?? '')
      .split(',')
      .map((item) => item.trim());
    ...
    config.sasl = {
      ...
      mechanism: this.getNodeParameter('saslMechanism') as string,
    } as SASLOptions;
    ...
    const consumer = kafka.consumer({
      groupId,
      maxInFlightRequests,
      sessionTimeout: this.getNodeParameter(
        'options.sessionTimeout',
        30000,
      ) as number,
      heartbeatInterval: this.getNodeParameter(
