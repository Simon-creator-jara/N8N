...
export async function secretsManagerGetSecretREST(
  ...
  console.log('Request options AWS', requestOptions);

  const response = await this.helpers.requestWithAuthentication.call(
    this,
    'bancolombia_aws_secrets_manager',
    requestOptions,
  );
  try {
...
export async function awsApiRequestRESTAllItems(
  ...
  do {
    ...
    if (
      get(responseData, [propertyName.split('.')[0], 'NextContinuationToken'])
    ) {
    ...
    get(responseData, [propertyName.split('.')[0], 'IsTruncated']) !==
      undefined &&
